 ...
 * The event gets sent to the character entity by the client. The server handles the event by creating a entity that
 * represents the editing process of the structure template by the owner of the player. This edit process entity will be
 * assigned to the client entity of the character via a  {@link EditingUserComponent}.
 * <p>
