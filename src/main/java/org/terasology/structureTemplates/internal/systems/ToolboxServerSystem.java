...
public class ToolboxServerSystem extends BaseComponentSystem {
    ...
    @ReceiveEvent(components = ToolboxComponent.class)
    public void onStructureSpawnerFromToolboxRequest(StructureSpawnerFromToolboxRequest event,
                                                     EntityRef toolboxEntity) {
        EntityRef owner = toolboxEntity.getOwner();
    ...
    @ReceiveEvent(components = ToolboxComponent.class)
    public void onStructureTemplateFromToolboxRequest(StructureTemplateFromToolboxRequest event,
                                                      EntityRef toolboxEntity) {
        EntityRef owner = toolboxEntity.getOwner();
     ...
     * @return a modified display name component if the entity builder has a display name component, or a new component
     *         otherwise
     */
    private DisplayNameComponent getDisplayNameComponent(final EntityBuilder entityBuilder, final Prefab prefab,
                                                         final String suffix) {
