 ...
 * entities with the {@lin PendingStructureSpawnComponent} in order to cause the spawning of a prefab with the {@link
 * StructureTemplateComponent} at the wanted locations.
 */
...
public class ScheduledStructureSpawnSystem extends BaseComponentSystem implements UpdateSubscriberSystem {
    ...
    private final List<EntityRef> pendingSpawnEntities = new ArrayList<>();
