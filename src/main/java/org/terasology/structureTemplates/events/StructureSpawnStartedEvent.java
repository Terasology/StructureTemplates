 ...
 * <p>
 * Implement a handler of {@link StructureSpawnStartedEvent} when you want to add a structure template component that
 * does something when the spawning of a structure starts . (e.g. placing some spawn particles or playing a placement
 * sound)
 */
